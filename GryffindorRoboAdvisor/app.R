...
ui <- dashboardPage(
  ...
  dashboardSidebar(width = 280,
                   sidebarMenu(
                     id = "tabs",
                     menuItem("Understand your risk preference", tabName = "risk", icon = icon("list-ol")),
                     menuItem("Map your interests", tabName = "Map", icon = icon("globe-americas")),
                     menuItem("Portfolio for you", tabName = "Portfolio", icon = icon("file-invoice-dollar"))
                   )
  ),
